...
namespace APS2
{
    public partial class RtosForm : Form
    {
        ...
        private void Start_Click(object sender, EventArgs e)
        {
            ...
            // Task 0
            System.Threading.ParameterizedThreadStart task0EntryPoint = new System.Threading.ParameterizedThreadStart(delegate (Object data) {
            ...
            // Task 1 
            System.Threading.ParameterizedThreadStart task1EntryPoint = new System.Threading.ParameterizedThreadStart(delegate (Object data)
            {
            ...
            // Task 2
            System.Threading.ParameterizedThreadStart task2EntryPoint = new System.Threading.ParameterizedThreadStart(delegate (Object data)
            {
                OS.Print("Starting task 2");
                OS.Print("Task 2 wating for Semaphore 0");
                _os.SemaphorePool[0].Wait(_os.TaskPool[2]);
                if (_os.SemaphorePool[1].Signal())
                    OS.Print("Task 2 Semaphore 1 signaled");
